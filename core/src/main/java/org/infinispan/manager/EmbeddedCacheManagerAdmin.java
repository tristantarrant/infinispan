...
public interface EmbeddedCacheManagerAdmin extends CacheContainerAdmin<EmbeddedCacheManagerAdmin, Configuration> {
    ...
    */
   <K, V> CompletionStage<Cache<K, V>> getOrCreateCacheAsync(String name, String template);

   /**
    * Asynchronous version of {@link #getOrCreateCache(String, Configuration)}
    */
   <K, V> CompletionStage<Cache<K, V>> getOrCreateCacheAsync(String name, Configuration configuration);
