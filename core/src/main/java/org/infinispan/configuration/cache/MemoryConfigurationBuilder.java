...
public class MemoryConfigurationBuilder extends AbstractConfigurationChildBuilder implements
   ...
   public MemoryConfigurationBuilder maxSizeInBytes(long size) {
   ...
   /**
    * The configured eviction strategy, please see {@link MemoryConfigurationBuilder#whenFull(EvictionStrategy)}.
