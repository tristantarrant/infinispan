...
public class GlobalAuthorizationConfiguration {
   ...
   public static final AttributeDefinition<AuditLogger> AUDIT_LOGGER = AttributeDefinition.builder("audit-logger", (AuditLogger) new NullAuditLogger())
         .copier(IdentityAttributeCopier.INSTANCE).serializer(AttributeSerializer.CLASS_NAME).immutable().build();
