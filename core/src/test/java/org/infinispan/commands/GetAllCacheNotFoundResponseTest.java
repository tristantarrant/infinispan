...
public class GetAllCacheNotFoundResponseTest extends MultipleCacheManagersTest {
   ...
   public void test() throws InterruptedException, ExecutionException, TimeoutException {
      ...
      ControlledRpcManager.BlockedRequests<ClusteredGetAllCommand> round1 =
      ...
      ControlledRpcManager.BlockedRequests<ClusteredGetAllCommand> round2 =
      ...
      ControlledRpcManager.BlockedRequests<ClusteredGetAllCommand> round3 =
   ...
   private Future<Void> simulateTopologyUpdate(Cache<Object, Object> cache) {
      ...
      ((DistributionManagerImpl) dm4).setCacheTopology(newTopology);
