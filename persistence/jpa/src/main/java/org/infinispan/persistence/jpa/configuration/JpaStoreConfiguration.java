...
public class JpaStoreConfiguration extends AbstractStoreConfiguration {
   ...
   static final AttributeDefinition<Class> ENTITY_CLASS = AttributeDefinition.builder(org.infinispan.persistence.jpa.configuration.Attribute.ENTITY_CLASS_NAME, null, Class.class).immutable().build();
