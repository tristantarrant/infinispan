...
public class JBMARRemoteQueryConditionsTest extends QueryConditionsTest {
   ...
   @Test(expectedExceptions = HotRodClientException.class, expectedExceptionsMessageRegExp = "org.infinispan.query.objectfilter.ParsingException: Input is not a valid date string: ")
