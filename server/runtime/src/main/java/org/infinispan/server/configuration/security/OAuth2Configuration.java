...
public class OAuth2Configuration extends ConfigurationElement<OAuth2Configuration> {
   ...
   static final AttributeDefinition<String> CLIENT_SECRET = AttributeDefinition.builder(Attribute.CLIENT_SECRET, null, String.class).serializer(AttributeSerializer.SECRET).build();
