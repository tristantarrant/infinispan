...
public interface CustomStringCommands extends Commands {
   ...
   @Command("SDIFFCARD :k1 :k2 :k3 :k4 :k5")
   Long sdiffcard5Args(@Param("k1") byte[] k1, @Param("k2") byte[] k2,
         @Param("k3") byte[] k3, @Param("k4") byte[] k4,
         @Param("k5") byte[] k5);
   ...
   String jsonMerge(@Param("key") String key, @Param("path") String path, @Param("value") String value);
