 ...
 * <p>
 * Returns the value at the given rank(s).
 *
 * @see <a href="https://redis.io/commands/tdigest.byrank/">TDIGEST.BYRANK</a>
 * @since 16.2
 */
public class TDIGESTBYRANK extends RespCommand implements Resp3Command {

   public TDIGESTBYRANK() {
      super("TDIGEST.BYRANK", -3, 1, 1, 1,
   ...
   public CompletionStage<RespRequestHandler> perform(Resp3Handler handler, ChannelHandlerContext ctx,
      ...
      for (int i = 1; i < arguments.size(); i++) {
         try {
            ...
            handler.writer().customError(ProbabilisticErrors.TDIGEST_ERROR_PARSING_RANK);
            return handler.myStage();
         }
      }
      ...
      TDigestByRankFunction function = new TDigestByRankFunction(ranks);
