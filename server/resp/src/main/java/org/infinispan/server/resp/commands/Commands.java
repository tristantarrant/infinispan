...
public final class Commands {
   ...
   static {
      ...
      ALL_COMMANDS[2] = new RespCommand[]{new CONFIG(), new COMMAND(), new COPY(), new CLUSTER(), new CLIENT(), new CFADD(), new CFADDNX(), new CFEXISTS(), new CFMEXISTS(), new CFRESERVE(), new CFINSERT(), new CFINSERTNX(), new CFDEL(), new CFCOUNT(), new CFINFO()};
