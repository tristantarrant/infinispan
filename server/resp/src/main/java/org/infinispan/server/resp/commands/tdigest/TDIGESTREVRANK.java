 ...
 * <p>
 * Returns the reverse rank of one or more values.
 *
 * @see <a href="https://redis.io/commands/tdigest.revrank/">TDIGEST.REVRANK</a>
 * @since 16.2
 */
public class TDIGESTREVRANK extends RespCommand implements Resp3Command {

   public TDIGESTREVRANK() {
      super("TDIGEST.REVRANK", -3, 1, 1, 1,
   ...
   public CompletionStage<RespRequestHandler> perform(Resp3Handler handler, ChannelHandlerContext ctx,
      ...
      for (int i = 1; i < arguments.size(); i++) {
         try {
            ...
            handler.writer().customError(ProbabilisticErrors.TDIGEST_ERROR_PARSING_VALUE);
            return handler.myStage();
         }
      }
      ...
      TDigestRevRankFunction function = new TDigestRevRankFunction(values);
