...
import org.infinispan.api.common.events.cache.CacheEntryListenerType;
...
public interface AsyncCache<K, V> {
    ...
    * @return
    */
   AsyncCache<K, V> withFlags(Set<Flag> flags);
    ...
    * @return
    */
   AsyncCache<K, V> withFlags(Flag... flags);
    ...
    * @return
    */
   default Flow.Publisher<CacheEntryEvent<K, V>> listen(CacheEntryListenerType... types) {
    ...
    * @param options
    * @param types one or more {@link CacheEntryListenerType}
    * @return
    */
