...
public interface CacheEntryEvent<K, V> {
    ...
    *     has {@link CacheListenerOptions#includeCurrentState()} set to <code>true</code>.
    * @since 9.3
    */
    ...
    *   In a transactional cache, it is the transaction object associated with the current call.
