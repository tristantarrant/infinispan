...
public abstract class AbstractConfigurationWriter implements ConfigurationWriter {
   ...
   @Override
   public void writeArrayElement(Enum<?> outer, Enum<?> inner, Iterable<String> values) {
      writeArrayElement(outer.toString(), inner.toString(), values);
   }
