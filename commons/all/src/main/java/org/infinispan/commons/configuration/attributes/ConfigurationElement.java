...
public abstract class ConfigurationElement<T extends ConfigurationElement> implements Matchable<T> {
   ...
   protected ConfigurationElement(Enum<?> element, boolean repeated, AttributeSet attributes, ConfigurationElement<?>... children) {
      this(element.toString(), repeated, attributes, children);
   }
