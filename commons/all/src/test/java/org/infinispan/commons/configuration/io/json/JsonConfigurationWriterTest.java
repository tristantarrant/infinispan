...
public class JsonConfigurationWriterTest {
   ...
   public void testWriteJson() {
      ...
      w.writeCharacters("w1");
      w.writeEndElement();
      w.writeStartElement("e2");
      w.writeCharacters("w2");
      w.writeEndElement();
      w.writeEndListElement(); // e2
      w.writeEndElement(); // e1
      w.writeStartListElement("e3", true);
      ...
      assertEquals("{\"e1\":{\"a1\":\"v1\",\"a2\":\"v2\",\"e2\":[\"w1\",\"w2\"]},\"e3\":[{\"a3\":\"v3\",\"a4\":\"v4\"},{\"a3\":\"v3\",\"a4\":\"v4\"}]}", json);
   }
}
