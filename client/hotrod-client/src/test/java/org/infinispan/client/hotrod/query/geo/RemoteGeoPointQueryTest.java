...
public class RemoteGeoPointQueryTest extends SingleHotRodServerTest {
   ...
   public void indexingAndSearch() {
      ...
      remoteCache.put(1, new Hiking("track 1", LatLng.of(41.907903484609356, 12.45540543756422),
            LatLng.of(41.90369455835456, 12.459566517195528)));
      remoteCache.put(2, new Hiking("track 2", LatLng.of(41.90369455835456, 12.459566517195528),
            LatLng.of(41.907930453801285, 12.455204785977637)));
      remoteCache.put(3, new Hiking("track 3", LatLng.of(41.907930453801285, 12.455204785977637),
