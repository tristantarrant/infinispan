 ...
 * @since 7.0
 */
@Test(testName = "client.hotrod.query.HotRodNonIndexedFileStoreQueryTest", groups = "functional")
public class HotRodNonIndexedFileStoreQueryTest extends HotRodNonIndexedQueryTest {
