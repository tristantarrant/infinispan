...
public class RemoteCacheManager implements RemoteCacheContainer, Closeable, RemoteCacheManagerMXBean {
   ...
   private static TransactionManager getTransactionManager(RemoteCacheConfiguration cacheConfiguration) {
      try {
   ...
   private static TransactionMode getTransactionMode(RemoteCacheConfiguration cacheConfiguration) {
