 ...
 */
@Experimental
final class HotRodAsyncTransaction implements AsyncTransaction {
   private final Transaction transaction;

   HotRodAsyncTransaction(Transaction transaction) {
   ...
   @Override
   public HotRodAsyncTransaction rollbackOnly() {
      try {
