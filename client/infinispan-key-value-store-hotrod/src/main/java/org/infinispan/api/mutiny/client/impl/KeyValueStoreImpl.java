package org.infinispan.api.mutiny.client.impl;
...
import org.infinispan.api.mutiny.client.impl.listener.ClientListenerImpl;
 ...
 * @since 10.0
 */
public class KeyValueStoreImpl<K, V> implements Cache<K, V> {
   ...
   @Override
   public Publisher<KeyValueEntry<K, V>> listen(KeyValueListener listener) {
      // TODO CHECK CAST. Now there is a single class that implements
      return new ClientListenerImpl(cache, (ClientKeyValueListener) listener);
   }
}
